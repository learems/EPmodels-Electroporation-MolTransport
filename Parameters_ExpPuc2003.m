...
% Time stepping
par.tlist1 = '10^{range(-8,(log10(tpulse[1/s])+8)/200,log10(tpulse[1/s]))} tpulse+10^{range(-8,(log10(1e-4)+8)/50,log10(1e-4))} tpulse+10^{range(log10(1e-4),(log10(2e2)-log10(1e-4))/350, log10(2e2))}';
par.tlist2 = '10^{range(-8,(log10(tpulse[1/s])+8)/20,log10(tpulse[1/s]))}  tpulse+10^{range(-8,(log10(1e-4)+8)/5,log10(1e-4))}  tpulse+10^{range(log10(1e-4),(log10(2e2)-log10(1e-4))/50, log10(2e2))}';
...
par.D1_e = 4.77e-10; % Extracellular diff. coefficient of solute 1 [m^2/s]
par.D1_i = 0.25*4.77e-10; % Intracellular diff. coefficient of solute 1 [m^2/s]
